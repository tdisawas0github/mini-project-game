...
const HubNavigation = ({ onNavigate }: HubNavigationProps) => {
  ...
  const hubOptions = [
    ...
    // New Web Version 5 Systems
    {
      id: 'quest_system',
      title: '📜 Quest Journal',
      description: 'Track all your adventures and missions across Valdaren',
      available: gameState.playerName !== ''
    },
    {
      id: 'memory_drift',
      title: '🌀 Memory Drift Zones',
      description: 'Explore unstable memories scattered across the realm',
      available: gameState.unlockedGlyphs.length >= 2
    },
    {
      id: 'advanced_language',
      title: '📚 Advanced Ellidric Studies',
      description: 'Master the ancient dialects and their hidden powers',
      available: gameState.knownLanguages.length >= 2
    },
    {
      id: 'systems_test',
      title: '🧪 Systems Test',
